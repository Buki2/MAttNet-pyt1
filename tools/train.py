...
def main(args):
  ...
  # dets_json = osp.join('cache/detections', opt['dataset_splitBy'], '%s_%s_%s_dets.json' % \
  ...
  # det_feats = osp.join('cache/feats', opt['dataset_splitBy'], 'mrcn',
  #                      '%s_%s_%s_det_feats.h5' % (opt['net_name'], opt['imdb_name'], opt['tag']))
